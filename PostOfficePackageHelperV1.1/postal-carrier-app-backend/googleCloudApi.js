...
const image_path = 'C:/Users/Dylan/PostOfficePackageHelper/PostOfficePackageHelperV1.1/PostOfficePackageHelperV1.1/postal-carrier-app-backend/image.png'
...
const detectText = async () => {
    let [result] = await client.textDetection(image_path)
